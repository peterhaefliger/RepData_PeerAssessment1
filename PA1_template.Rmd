...
The obviours difference between this diagram and the one without the imputed values above is the peak at the mean/median: Where there were only 3 values before, with the additional 8 values we have placed at the mean, there are now 11 values in total, more than in any other bin.
